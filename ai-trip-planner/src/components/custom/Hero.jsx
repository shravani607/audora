      ...
      <div className="relative bg-gradient-to-b from-[#dcebfe] to-yellow-100 bg-opacity-50 p-6 rounded-lg shadow-md">
        <div className="relative z-10 text-center mb-12 text-black">
          <h1 className="text-5xl font-extrabold hero-title mb-4">
            Discover Your Perfect Trip with Audora
          </h1>
          <p className="text-xl hero-description mb-3 font-semibold">
            Audora is your ultimate AI-powered travel companion. Tell us your
            travel preferences, and we'll craft the perfect itinerary just for you.
          </p>
        ...
        <div className="cta-section relative z-10 text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            {/* 🎥 AI Scene Describer Button */}
            <Link to="/scene-describer">
              <Button className="py-3 px-6 text-lg font-bold bg-purple-600 hover:bg-purple-700">
                🎥 AI Scene Describer
              </Button>
            </Link>
          </div>
